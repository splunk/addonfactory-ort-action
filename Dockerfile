...
RUN pip3 install virtualenv==20.2.2 dephell pipenv
RUN pip3.7 install virtualenv==20.2.2 dephell pipenv
RUN pip3.8 install virtualenv==20.2.2 dephell pipenv
